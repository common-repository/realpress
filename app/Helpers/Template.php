...
class Template {
	...
	protected function get_frontend_template( string $file_name = '', array $args = array() ) {
		...
		$default_path        = REALPRESS_VIEWS . "frontend/{$file_name}";
		$folder_name_rewrite = apply_filters( 'realpress/template/frontend/folder-name-override', REALPRESS_FOLDER_ROOT_NAME );
