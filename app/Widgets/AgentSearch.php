...
class AgentSearch extends \WP_Widget {
	private $settings;

	public function __construct() {
		$this->settings = Config::instance()->get( 'agent-search', 'widgets' );
		parent::__construct(
			'realpress_agent_search',
			esc_html__( '(RealPress) Agent Search', 'realpress' ),
			array(
				'description' => esc_html__( "This widget only work on Agent List page and Agent page" ),
			)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		Template::instance()->get_frontend_template_type_classic( 'widgets/agent-search.php' );
